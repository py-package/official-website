...
export default function Home({ posts }) {
  return (
    <>
      ...
      <p className="mt-8 pt-8 text-center">
        PyPackage is an open-source platform which creates lots of great open source projects. Right
      ...
      <p className="mt-4 text-center">
        ...
        improvements going on and soon it will be a full-fledged framework. There are lots of
        projects being created using Masonite. For more details about Masonite, please visit{' '}
