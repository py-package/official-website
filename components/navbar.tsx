    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <Link href="/">
                    <a className="mx-2 font-semibold" title="Home Page">Home</a>
                </Link>
                <Link href="/packages">
                    <a className="mx-2 font-semibold" title="Packages Page">Packages</a>
                </Link>
                <Link href="/tutorials">
                    <a className="mx-2 font-semibold" title="Tutorials Page">Tutorials</a>
                </Link>
            </div>
